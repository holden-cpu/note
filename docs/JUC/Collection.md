...
![image-20210722172311272](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20210722172311272.png)

当我们同时启动30个线程去操作List的时候

```java
public class ContainNatSafeDemo {
    public static void main(String[] args) {
...
![image-20210722173422921](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20210722173422921.png)
...
![image-20200312210401865](https://gitee.com/moxi159753/LearningNotes/raw/master/校招面试/JUC/4_ArrayList为什么线程不安全/ArrayList线程不安全的举例/images/image-20200312210401865.png)
...
![image-20210722202636005](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20210722202636005.png)

### HashSet底层结构

同理HashSet的底层结构就是HashMap

![image-20200312221735178](https://gitee.com/moxi159753/LearningNotes/raw/master/校招面试/JUC/4_ArrayList为什么线程不安全/ArrayList线程不安全的举例/images/image-20200312221735178.png)
...
为什么不是set 的 value不是为null？

当重复添加时，map::put()返回的是被覆盖的值。如果value为null，则set::add()重复添加时就会返回true。
