视频参考：[雷丰阳2021版SpringBoot2](https://www.bilibili.com/video/BV19K4y1L7MT)
...
去扫描某些包及其子包中所有的类，然后将满足一定条件的类作为bean注册到spring容器容器中。

[@ComponentScan的详细介绍](https://mp.weixin.qq.com/s/mVdARYO5N-ZgU4e0QdAgRg)
...
导入 `AutoConfigurationPackages.Registrar.class`

` AutoConfigurationPackages` 该类用于存入自动配置包，以便以后引用

利用`Registrar`给容器中导入一系列组件

- **默认**将`MainApplication`所在包下的所有组件导入（注册）进来

![image-20211017132158333](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20211017132158333.png)

![image-20211017131319093](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20211017131319093.png)

##### @Import(AutoConfigurationImportSelector.class)

1、利用`getAutoConfigurationEntry(annotationMetadata)`;给容器中批量导入一些组件

![image-20211017205750130](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20211017205750130.png)

2、调用`List<String> configurations = getCandidateConfigurations(annotationMetadata, attributes)`获取到所有需要导入到容器中的配置类

![image-20211017210121906](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20211017210121906.png)

3、利用工厂加载 `Map<String, List<String>> loadSpringFactories(@Nullable ClassLoader classLoader)`；得到所有的组件

![image-20211017210148652](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20211017210148652.png)
...
![image-20211017210319349](https://note-java.oss-cn-beijing.aliyuncs.com/img/image-20211017210319349.png)
...
<img src="https://note-java.oss-cn-beijing.aliyuncs.com/img/1603181460034-ba25f3c0-9cfd-4432-8949-3d1dd88d8b12.png" alt="img"  />
